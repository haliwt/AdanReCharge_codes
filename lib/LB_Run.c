		...
		case 0x02: //
			...
			case 6:  //??	
				...
				else if(RunMs>300)
				{
					...
					RunMs=0;
					RunStep=0;
//					timeCircle = 13;//WT.EDIT 半圈 //27;//timeCircle = 50;
//					InitMotorRightCircleRecharge();
				}
		...
		case 7:
               if(IMP>0 ||(WallDp[0]>WallMin)||(WallDp[1]>WallMin)) //WT.EDIT 2021.01.19
			   {
				...
				{
					//timeCircle = 10;//WT.EDIT 半圈 //27;//timeCircle = 50;
					SetStop();
		...
		case 0x40:   //far away
		{
		   ...
		   if(IMP>0 ||(WallDp[0]>WallMin)||(WallDp[1]>WallMin)||(WallDp[2]>WallMin)||(WallDp[3]>WallMin)) //WT.EDIT 2021.01.19
			...
			else if(RunMs >30)//else if(RunMs>40 ) //WT.EDIT 
			{
				RunMs=0;
				distance = 0;
				lostCnt = 0;
		   ...
		   if(IMP>0 ||(WallDp[0]>WallMin)||(WallDp[1]>WallMin)||(WallDp[2]>WallMin)||(WallDp[3]>WallMin)) //WT.EDIT 2021.01.19
			...
			else if(RunMs >30)//else if(RunMs>40 ) //WT.EDIT 
			{
			   ...
			   else
				{
						...
						{
										RunNoIRsenorTime++;
					      if(RunNoIRsenorTime>3)//if(RunNoIRsenorTime>5)
						  {							  
				         RunStep=0x3;
				         SetStop();	
						  }							  
