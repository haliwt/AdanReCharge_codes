...
//			ADCtl = 0;
			ClearAllIR();
            timeCircle= 27;// –˝◊™µƒ ±º‰//timeCircle= 50;//
		...
		case 0x02: //
			...
			case 6:  //÷±◊ﬂ	
				...
				else if(RunMs>300)
				{
					...
					RunMs=0;
					RunStep=5;
//					timeCircle = 13;//WT.EDIT ÂçäÂúà //27;//timeCircle = 50;
//					InitMotorRightCircleRecharge();
				}
		...
		case 7:
               if(IMP>0 ||(WallDp[0]>WallMin)||(WallDp[1]>WallMin)) //WT.EDIT 2021.01.19
			   {
				...
				{
					//timeCircle = 10;//WT.EDIT ÂçäÂúà //27;//timeCircle = 50;
		...
		case 0x37:  //ÊÅ¢Â§çÂà∞ÂéüÊù•Áõ¥Á∫ø‰∏äÔºåÂè≥ËΩ¨90Â∫¶
		   if(RunMs>30)
			  {
			  	  InitMotorRight_TOPIR();//right
				  RunStep=0x38;
		...
		break;
		case 0x38: //ÊÅ¢Â§çÂà∞Áõ¥Á∫øÔºåÁªßÁª≠Ê£ÄÊµã--‰∏≠ÁÇπ‰ø°Âè∑
